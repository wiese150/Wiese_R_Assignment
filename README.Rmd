...
for (i in 1:10) {
  assign(paste("m_chr_", i), subset(merged_maize_geno, Chromosome == i))
  write.table(x = get(paste("m_chr_", i)), file = paste("maize_chromosome_", i, ".txt"), quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE)
}
for (i in 1:10) {
  assign(paste("t_chr_", i), subset(merged_teosinte_geno, Chromosome == i))
  write.table(x = get(paste("t_chr_", i)), file = paste("teosinte_chromosome_", i, ".txt"), quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE)
}
```
## Data Visualization