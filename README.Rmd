...
Now it's necessary to prepare the snp object for merging.  Unlike in the pure git method we used before, we don't actually need to remove the header for this:  The column names are just column names, and are actually key to merging, as alluded above.
